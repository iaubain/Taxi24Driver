...
import com.driver.logic.Command;
...
public class Services {
    ...
    @RequestMapping( method = RequestMethod.POST, produces=MediaType.APPLICATION_JSON_VALUE, value = "/Taxi24Driver/driver/process/fact")
    @ResponseBody
